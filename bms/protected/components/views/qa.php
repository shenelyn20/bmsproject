...
<center><b><h3>Year <input type="number" id="year" onchange="updateContents();"> Allotments Released</h3></center>
<?php if($models == null): ?>
<table>
...
<table id="qo_table">
	...
	<tr>
		...
		<td><?php echo number_format($model->first_quarter_ar,2);?></td>
		<td><?php echo number_format($model->second_quarter_ar,2);?></td>
		<td><?php echo number_format($model->third_quarter_ar,2);?></td>
		<td><?php echo number_format($model->fourth_quarter_ar,2);?></td>
		<td><?php echo number_format($model->first_quarter_ar + $model->second_quarter_ar + $model->third_quarter_ar +$model->fourth_quarter_ar,2);?></td>
	</tr>
	<?php endforeach; ?>
</table>
<?php endif; ?>
