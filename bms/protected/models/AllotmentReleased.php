...
/**
 * This is the model class for table "bms.allotment_released".
 *
 * The followings are the available columns in table 'bms.allotment_released':
 ...
 */
class AllotmentReleased extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('ar_id, implementing_unit, mfo_ppas, description, release_date, amount', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return AllotmentReleased the static model class
	 */
